...
<head>
    ...
    <link rel="shortcut icon" href="fingers.ico">
</head>
...
<body>
        ...
        <div class="container">
            <div class="row" style="height: 100px;">
                <div class=" col-xs-8 col-md-8">
                    ...
                    <span style="padding-left: 90px; font-family: 'Lobster', cursive;"><small><em>" Berita terhangat masa kini "</em></small></span>
                </div>
                <div class="col-xs-4 col-md-4" style="padding-top: 15px; text-align: right;">
                    <a href="../pertemuan9/hal-admin/index.php" style="text-decoration: none; color: cornflowerblue;"><i class="fa fa-sign-in"></i>  Sign in &nbsp;</a><br><br>
    ...
    <nav id="myNavbar" class="navbar navbar-expand-lg" style="background: linear-gradient(to left, #a1ffce, #faffd1); height: 70px;">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="margin-left: 30px;">
                <ul id="highlight" class="nav navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php">Kuliner &nbsp;</a>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="/pertemuan9/artikel/olahraga.php">Olah-raga &nbsp;</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pertemuan9/artikel/teknologi.php">Teknologi &nbsp;</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/pertemuan9/artikel/games.php">Games &nbsp;</a>
                    </li>
                </ul>
    ...
    <section id="home">
        <div class="container">
            <h1 style="color: cornflowerblue; font-weight: bold;">Olah Raga</h1>
        </div><br>
    </section>
    <section id="content">
        <div class="container">
